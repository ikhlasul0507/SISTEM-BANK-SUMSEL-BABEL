...
INPUT DATA MEMO MASUK</u></font></p></b></h2><center>
<form name="frmmenu3"
method="post"
action="menu3act.php">
<div class="col-md-10">
...
<td>No.Memo</td>
<td>:</td>
<td><input type="text" class="form-control" name="nomemomsk" maxlength="50"></td>
</tr>
<tr>
<td>Tanggal Memo</td>
<td>:</td>
<td><input type="text" class="form-control" name="tglmemomsk" maxlength="10"></td>
</tr>
<tr>
<td>Perihal</td>
<td>:</td>
<td><input type="text" class="form-control" name="hal2" maxlength="150"></td>
</tr>
<tr>
<td>Pengirim</td>
<td>:</td>
<td><input type="text" class="form-control" name="pgrm2" maxlength="75"></td>
</tr>
<tr>
<td>Penerima</td>
<td>:</td>
<td><input type="text" class="form-control" name="penerima2" maxlength="30"></td>
</tr>
<tr>
<td>Tanggal Terima</td>
<td>:</td>
<td><input type="text"  class="form-control" name="tglterima2" maxlength="10"></td>
</tr>
<td></td>
<td></td>
<td><input type="submit" class="btn btn-primary"  name="tblsimpan" value="SIMPAN"></td>
</tr>
</h2>
</table>
</p>
