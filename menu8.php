...
DISPLAY DATA MEMO KELUAR</p></h1></font><hr><center>
	<!-- Cari dan print -->
	<div class="input-group col-md-11 ml-5">
		<form method="get" action="#">
		  ...
		  <div class="input-group-append" id="button-addon4">
		    ...
		    <a href="print8.php" target="_blank" class="btn btn-outline-primary ml-2" type="button" >Print</a>
		  </div>
		</div>
...
$result=$sia_connect->query("select * from tblmemoklr where hal3 like '%".$cari."%'");
...
<tr>
<td>$no</td>
<td>$tblvar[nomemoklr]</td>
<td>$tblvar[tglmemoklr]</td>
<td>$tblvar[hal3]</td>
<td>$tblvar[tujuan2]</td>
<td>$tblvar[penerima3]</td>
<td>$tblvar[tglkirim2]</td>
<td><a href=menu81.php?nomemoklr=$tblvar[nomemoklr] class='badge badge-primary'>EDIT</a></td>
<td><a href=menu82.php?nomemoklr=$tblvar[nomemoklr] class='badge badge-danger'>DROP</a></td>
</tr>");
$no++;
}
}
...
print("
	...
	$result=$sia_connect->query("select * from tblmemoklr order by nomemoklr");
if($result->num_rows > 0)
{
$no=1;
while($tblvar=$result->fetch_assoc())
