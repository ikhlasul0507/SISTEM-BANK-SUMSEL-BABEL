	...
	<div class="input-group col-md-11 ml-5">
		<form method="get" action="#">
		  ...
		  <div class="input-group-append" id="button-addon4">
		    ...
		    <a href="print5.php" target="_blank" class="btn btn-outline-primary ml-2" type="button" >Print</a>
		  </div>
		</div>
...
if(isset($_GET['cari'])){
	...
	//	$data = mysql_query("select * from mhs where nama like '%".$cari."%'");	
		$result=$sia_connect->query("select * from tblsrtmsk where hal like '%".$cari."%'");
				...
				<td><a href=menu51.php?nosuratmsk=$tblvar[nosuratmsk] class='badge badge-primary'>EDIT</a></td>
				<td><a href=menu52.php?nosuratmsk=$tblvar[nosuratmsk] class='badge badge-danger'>DROP</a></td>
				</tr>");
				$no++;
				}
				}
