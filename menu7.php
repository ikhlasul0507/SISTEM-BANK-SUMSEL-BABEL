	...
	<div class="input-group col-md-11 ml-5">
		<form method="get" action="#">
		  ...
		  <div class="input-group-append" id="button-addon4">
		    ...
		    <a href="print7.php" target="_blank" class="btn btn-outline-primary ml-2" type="button" >Print</a>
		  </div>
		</div>
...
$result=$sia_connect->query("select * from tblmemomsk where hal2 like '%".$cari."%'");
...
<td><a href=menu71.php?nomemomsk=$tblvar[nomemomsk] class='badge badge-primary'>EDIT</a></td>
<td><a href=menu72.php?nomemomsk=$tblvar[nomemomsk] class='badge badge-danger'>DROP</a></td>
</tr>");
$no++;
}
}
